...
if __name__ == "__main__":
    ...
    try:
        ...
        print("  python math.py")
        print("  # Use custom dataset names")
        print("  python math.py --dataset1 aime25 --dataset2 math500")
        print("  # With limits")
        print("  python math.py --max-dataset1 10 --max-dataset2 50")
        print("  # Use full paths if needed")
        print("  python math.py --dataset1 math_datasets/aime25.json --dataset2 math_datasets/math500.json")
