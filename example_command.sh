...
python client.py -t "Resolve a critical question in diffusion model and related problems according to the paper" -m deepseek-ai/DeepSeek-R1-Distill-Llama-8B -p data/papers/iclr23_diffusion -d cuda -w 4

python server.py -i output -f output/paper_*.json -m deepseek-ai/DeepSeek-R1-Distill-Llama-8B -d cuda -o encyclopedia -w 4
